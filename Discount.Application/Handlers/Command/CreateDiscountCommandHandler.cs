...
{
    public class CreateCouponCommandHandler : IRequestHandler<CreateDiscountCommand>
    {
        private readonly IDiscountCommandRepository _commandRepository;
        private readonly IMapper _mapper;

        public CreateCouponCommandHandler(IDiscountCommandRepository commandRepository, IMapper mapper)
        {
